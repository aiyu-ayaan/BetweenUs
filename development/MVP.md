...
- ~~Replies~~ (shipped: a quote inside the encrypted body, on all three
  clients), ~~direct messages~~ (phase 12), ~~message deletion~~, ~~editing~~,
  ~~reactions~~, pins and in-client search (phase 15)
