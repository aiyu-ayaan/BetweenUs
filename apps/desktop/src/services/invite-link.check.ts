...
assert.equal(
  inviteLink('https://nexora.example.com', 'k3m9x2qp'),
  'https://nexora.example.com/invite/k3m9x2qp',
);
// A base with a trailing slash must not produce a double one - `//invite` is a
// path Nginx will not match.
assert.equal(inviteLink('https://nexora.example.com/', 'abc'), 'https://nexora.example.com/invite/abc');

// What people actually paste.
assert.equal(inviteCodeFrom('https://nexora.example.com/invite/k3m9x2qp'), 'k3m9x2qp');
assert.equal(inviteCodeFrom('  https://nexora.example.com/invite/k3m9x2qp  '), 'k3m9x2qp');
assert.equal(inviteCodeFrom('https://nexora.example.com/invite/k3m9x2qp?from=chat'), 'k3m9x2qp');
assert.equal(inviteCodeFrom('https://nexora.example.com/invite/k3m9x2qp#top'), 'k3m9x2qp');
...
assert.equal(inviteCodeFrom('https://nexora.example.com/'), null, 'a link to no invite');
