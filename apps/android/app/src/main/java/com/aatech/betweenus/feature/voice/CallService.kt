...
class CallService : Service() {
    ...
    companion object {
        /**
         * A new id rather than the old `betweenus.calls`: the importance of an
         * existing channel cannot be raised, and a `CallStyle` notification on
         * a low-importance channel is shown as an ordinary one.
         */
        private const val CHANNEL_ID = "betweenus.calls.ongoing"
        ...
        private const val ACTION_HANG_UP = "com.aatech.betweenus.call.HANG_UP"
        private const val ACTION_TOGGLE_MUTE = "com.aatech.betweenus.call.TOGGLE_MUTE"
