...
import com.aktech.nexora.core.data.jsonArrayOfObjects
import com.aktech.nexora.core.data.map
...
internal abstract class NexoraDatabase : RoomDatabase() {
 ...
 *
 * The point of it is that opening Nexora shows a conversation rather than a
...
object Cache {
    ...
    @Volatile
    private var db: NexoraDatabase? = null
