...
class InviteLinkTest {
    ...
    fun `builds a link against a deployment`() {
        assertEquals(
            ...
            InviteLink.of("https://nexora.example.com", "k3m9x2qp"),
        )
        assertEquals(
            "https://nexora.example.com/invite/k3m9x2qp",
            InviteLink.of("https://nexora.example.com/", "k3m9x2qp"),
    ...
    fun `reads the code out of a link`() {
        assertEquals("k3m9x2qp", InviteLink.codeIn("https://nexora.example.com/invite/k3m9x2qp"))
        assertEquals("k3m9x2qp", InviteLink.codeIn("  https://nexora.example.com/invite/k3m9x2qp  "))
        assertEquals("k3m9x2qp", InviteLink.codeIn("https://nexora.example.com/invite/k3m9x2qp?from=chat"))
        assertEquals("k3m9x2qp", InviteLink.codeIn("https://nexora.example.com/invite/k3m9x2qp#top"))
        assertEquals("k3m9x2qp", InviteLink.codeIn("https://nexora.example.com/?invite=k3m9x2qp"))
