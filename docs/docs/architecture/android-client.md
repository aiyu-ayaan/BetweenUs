...
<p style={{textAlign: 'center'}}>
  <video src={useBaseUrl('img/video.mp4')} alt="BetweenUs Android client" style={{maxWidth: '320px', width: '100%', borderRadius: '16px', border: '1px solid var(--ifm-toc-border-color)', boxShadow: '0 8px 30px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
</p>
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px', margin: '24px 0'}}>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="Server & Channel Navigation" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
    <p style={{marginTop: '8px', fontSize: '0.9rem', fontWeight: 600}}>Server & Channel Rail</p>
  </div>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="E2EE Chat & Composer" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
    <p style={{marginTop: '8px', fontSize: '0.9rem', fontWeight: 600}}>E2EE Chat & Composer</p>
  </div>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="Voice Lounge & Call Stage" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
    <p style={{marginTop: '8px', fontSize: '0.9rem', fontWeight: 600}}>Voice Lounge & Call Stage</p>
  </div>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="Material You & 16 Themes" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
    <p style={{marginTop: '8px', fontSize: '0.9rem', fontWeight: 600}}>Appearance & Themes</p>
  </div>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="Settings Hub & Account" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
    <p style={{marginTop: '8px', fontSize: '0.9rem', fontWeight: 600}}>Settings Hub & Account</p>
  </div>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="24-Hour Moments Tray" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
    <p style={{marginTop: '8px', fontSize: '0.9rem', fontWeight: 600}}>24-Hour Moments Tray</p>
  </div>
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="Permissions Dashboard" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
  ...
  <div style={{textAlign: 'center'}}>
    <video src={useBaseUrl('img/video.mp4')} alt="Friends & Direct Messages" style={{width: '100%', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 24px rgba(0,0,0,0.4)'}} autoPlay loop muted playsInline />
