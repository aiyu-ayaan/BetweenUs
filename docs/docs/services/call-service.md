...
| --- | --- | --- |
| POST | `/ice` | ICE server configuration (STUN always; a relay when one is configured — the long-term credential of the TURN server the operator runs, read from the environment) |
