...
You can find all the details about the project under @development or @Agents.md.
Yor are strictly advice to use the things mention of @development or @Agents.md, and you should not use any other resources or references outside of it.
